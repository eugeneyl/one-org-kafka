...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	orders := []Order{
		Order{OrderId: "1234567", CustomerId: "7654321", Status: "Delivered"},
		Order{OrderId: "1234568", CustomerId: "7654322", Status: "Delivered"},
		Order{OrderId: "1234569", CustomerId: "7654323", Status: "Delivered"},
	}
	// cars := []Car{
...
func (s *SmartContract) createOrder(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var order = Order{OrderId: args[1], CustomerId: args[2], Status: args[3]}
